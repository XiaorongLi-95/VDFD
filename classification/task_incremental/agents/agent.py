...
class Agent(nn.Module):
    def __init__(self, agent_config):
        ...
        self.multihead = True if len(self.config['out_dim']) > 1 else False  # A convenience flag to indicate multi-head
        self.task_count = 0
        ...
        if self.with_head:
            ...
            if self.reset_model_optimizer is False:
                ...
                warnings.warn('the head for previous task may be '
                              'not constrained and updated if the '
