...
def run(args):
    ...
    agent_config = {'model_lr': args.model_lr, 'head_lr': args.head_lr, 'hypermodel_lr': args.hypermodel_lr, 
                    ...
                    'hypermodel_weight_decay': args.hypermodel_weight_decay, 'head_weight_decay': args.head_weight_decay,
...
def get_args(argv):
    ...
    parser.add_argument('--agent_type', type=str, default='vidfd_coscls_gcn', help="The type (filename) of agent")
    parser.add_argument('--agent_name', type=str, default='DFD', help="The class name of agent")
