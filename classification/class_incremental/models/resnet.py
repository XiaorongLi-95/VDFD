...
def resnet32():
    return PreActResNetImage(PreActBlock, [3, 4, 6, 3], num_classes=10)


def resnet50():
    return PreActResNetImage(PreActBottleneck, [3, 4, 6, 3], num_classes=10)


def resnet101():
    return PreActResNetImage(PreActBottleneck, [3, 4, 23, 3], num_classes=10)
