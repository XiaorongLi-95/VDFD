...
def run(args):
    ...
    if args.resume_first:
        ckpt_path = os.path.join('./checkpoint', dataset_name, 'task0_bs{}_lr{}_hlr{}_wd{}_epoch{}.pth'.format(args.batch_size,args.model_lr,args.head_lr,args.model_weight_decay,args.schedule[-1]))
    else:
        ckpt_path = None
    agent_config = {'model_lr': args.model_lr, 'head_lr': args.head_lr, 'hypermodel_lr': args.hypermodel_lr,
                    ...
                    'model_optimizer': args.model_optimizer, 'hypermodel_optimizer': args.hypermodel_optimizer,
...
def get_args(argv):
    ...
    parser.add_argument('--agent_type', type=str, default='vidfd_labeltrick_margin', help="The type (filename) of agent")
